...
elseif strcmp(legendtype,'colorbar')
    ...
    if max(plotvariable)>10^4; legEnt=num2str(tick_val','%10.2E'); else legEnt=num2str(chop(tick_val',4)); end; 
...
%       catt(catt==0)=nan; 
   ...
   if max(cClass)>10^4; legEnt=num2str(cClass','%10.2E'); else legEnt=num2str(chop(cClass',4)); end; % prepare the text for the legend
