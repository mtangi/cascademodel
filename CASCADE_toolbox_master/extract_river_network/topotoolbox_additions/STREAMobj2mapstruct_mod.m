...
if nargin <= 2;
    ...
    % add artificial confluences
    global ArtificialConfluences

    if ~isempty(ArtificialConfluences)
       confluences = or(confluences , ArtificialConfluences);
    end
    ...
    % douplicate nodes at remaining confluences (insert rows)
